...
import {PasswordHasherBindings, TokenServiceBindings, TokenServiceConstants, UserServiceBindings} from './security/keys';
...
export class Generador31Application extends BootMixin(
